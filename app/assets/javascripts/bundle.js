...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BrowserHistory = __webpack_require__(166);
	...
	var documentReady = function documentReady() {
	  ...
	  if (reactNode) {
	    _reactDom2.default.render(_react2.default.createElement(
	      _reactRouter.Router,
	      { history: _BrowserHistory.history },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _URLUtils = __webpack_require__(170);

	var _Location = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qs = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoutingUtils = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riskbox = __webpack_require__(197);
	...
	var _patientbox = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riskslist = __webpack_require__(198);

	var _riskslist2 = _interopRequireDefault(_riskslist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var RiskBox = _react2.default.createClass({
		displayName: 'RiskBox',

		loadRisksFromServer: function loadRisksFromServer() {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				cache: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _risk = __webpack_require__(199);

	var _risk2 = _interopRequireDefault(_risk);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var RisksList = _react2.default.createClass({
		displayName: 'RisksList',

		render: function render() {
			var riskNodes = this.props.data.map(function (risk) {
				risk.formattedDate = moment(risk.updated_at).fromNow();
				return _react2.default.createElement(_risk2.default, _extends({ key: risk.id }, risk));
			});
			return _react2.default.createElement(
				'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkslist = __webpack_require__(201);
	...
	var CheckBox = _react2.default.createClass({
		...
		loadChecksFromServer: function loadChecksFromServer() {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				cache: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChecksList = _react2.default.createClass({
		displayName: 'ChecksList',

		render: function render() {
			var checkNodes = this.props.data.map(function (check) {
				check.formattedDate = moment(check.updated_at).fromNow();
				return _react2.default.createElement(_check2.default, _extends({ key: check.id }, check));
			});
			return _react2.default.createElement(
				'div',
				{ className: 'card-panel' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _patientslist = __webpack_require__(204);

	var _patientslist2 = _interopRequireDefault(_patientslist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PatientBox = _react2.default.createClass({
		displayName: 'PatientBox',

		loadPatientsFromServer: function loadPatientsFromServer() {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				cache: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _patient = __webpack_require__(205);

	var _patient2 = _interopRequireDefault(_patient);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PatientsList = _react2.default.createClass({
		displayName: 'PatientsList',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Patient = _react2.default.createClass({
		displayName: "Patient",
